...
parser.add_argument('--model_dir', type=str) # /data/duongdb/WS22qOther_05052021/Classify/b4ns448Wl1ss10lr0.0001dp0.2b48ntest1
...
for level in folder_list_todo: # _test_1 # ,'_test_integrated_gradient2'
  ...
  if args.condition_name is not None: 
    imlist_in_1_fold = [ i for i in imlist_in_1_fold if re.findall ('^'+args.condition_name, i) ] # disease name
    print ('num img found in',args.condition_name, len(imlist_in_1_fold))
